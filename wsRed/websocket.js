...
module.exports = function(RED) {
    ...
    function WebSocketContexNode(n) {
        // Create a RED node
    ...
    RED.nodes.registerType("websocket-listener",WebSocketContexNode);
    RED.nodes.registerType("websocket-client",WebSocketContexNode);

    WebSocketContexNode.prototype.registerInputNode = function(/*Node*/handler) {
        this._inputNodes.push(handler);
    }

    WebSocketContexNode.prototype.removeInputNode = function(/*Node*/handler) {
    ...
    WebSocketContexNode.prototype.handleEvent = function(id,/*socket*/socket,/*String*/event,/*Object*/data,/*Object*/flags){
        var msg;
        if (this.wholemsg) {
            try {
                msg = JSON.parse(data);
    ...
    WebSocketContexNode.prototype.broadcast = function(data) {
        try {
            if(this.isServer) {
    ...
    WebSocketContexNode.prototype.reply = function(id,data) {
    ...
    RED.nodes.registerType("wsContext in",WebSocketInNode);
    ...
    RED.nodes.registerType("wsContext out",WebSocketOutNode);
}
